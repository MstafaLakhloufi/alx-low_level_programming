 ...
 * @e_ident: A pointer to contain the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
 ...
 *   * @e_ident: A pointer to contain the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
...
/**
 * print_abi - Prints the ABI version of ELF
 * @e_ident: A pointer to contain the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_ident: A pointer contain the ELF magic numbers.
 *
 */
void print_magic(unsigned char *e_ident)
{
 ...
 * @e_ident: A pointer contain the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
